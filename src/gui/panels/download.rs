    ...
    pub fn render(&mut self, ui: &mut Ui) {
        ...
        if self.total_files > 0 {
            ...
            ui.add(egui::ProgressBar::new(progress)
                .show_percentage()
                .text(format!("{}/{} files", self.completed_files, self.total_files)));
            ...
            ui.group(|ui| {
                ...
                ui.horizontal(|ui| {
                    ...
                    ui.label(format!("Remaining: {}", self.total_files - self.completed_files - self.failed_files));
                });
                
                if self.current_speed > 0.0 {
                    ui.horizontal(|ui| {
                        ui.label(format!("Speed: {:.2} MB/s", self.current_speed / 1_000_000.0));
